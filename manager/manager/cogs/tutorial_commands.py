...
class TutorialCommands(commands.GroupCog, group_name="tutorial", group_description="Get help with OpenShapes setup"):
    def __init__(self, bot: commands.Bot):
        self.bot = bot

    @app_commands.command(name="token", description="Learn how to get a Discord bot token and enable intents")
...
async def setup(bot: commands.Bot):
    await bot.add_cog(TutorialCommands(bot))